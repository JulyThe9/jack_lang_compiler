...
public:
    ...
    bool whileStateBeh(parserState &pState)
    {
        ...
        auto *whileNode = createAstNode(pState, whileToken);

        // add WHILE_START node
        // we will jump to the lable generated by this node
        // in the resulting code
        whileNode->addChild(ALLOC_AST_NODE(TokenTypes::tWHILE_START));
    ...
    bool ifStateBeh(parserState &pState)
    {
        ...
        auto *ifNode = createAstNode(pState, ifToken);
    ...
    bool elseStateBeh(parserState &pState)
    {
        ...
        auto *elseNode = createAstNode(pState, elseToken);
